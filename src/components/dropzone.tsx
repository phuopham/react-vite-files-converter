      ...
      <div className="space-y-6">
        {actions.map((action: Action, i: any) => (
          ...
          >
            ...
            {action.is_error ? (
              <div className='rounded-full px-3 py-1 bg-red-500 flex items-center gap-1'>
                <span>Error Converting File</span>
                <BiError />
              </div>
            ) : action.is_converted ? (
              <div className='rounded-full px-3 py-1 bg-green-500 flex items-center gap-1'>
                <span>Done</span>
                <MdDone />
              </div>
            ) : action.is_converting ? (
              <div className='rounded-full px-3 py-1 bg-lime-400 flex items-center gap-1'>
              ...
              <div className="text-md flex items-center gap-4">
                <span className="text-gray-950">Convert to</span>
                <Select
